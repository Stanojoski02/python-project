import re
import text2emotion
_input =  "C:/Users/Andreas/Documents/EMOTION/data/email.txt"
output = data_output = "C:/Users/Andreas/Documents/EMOTION/data/output.txt"

def cleaner(_input,output):
    with open(_input, "r",encoding="utf8") as d:
