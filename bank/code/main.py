...
def for_pw():
    try:
        accaunt_sid = "AC9f6c9bad013e766965ac1c6bb3d9ae9f"
        auth = "5623bed8437c8b765186e5685324337f"
        from_phone = "+15075754169"
        ...
        if not user:
            ...
            message = client.messages.create(to="+38978349353", from_=from_phone, body=f"Your password is /{pw}/ ")
